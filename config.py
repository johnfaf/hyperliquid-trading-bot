...
LIVE_SUBTRACT_FEES_FROM_PNL = _safe_env_bool("LIVE_SUBTRACT_FEES_FROM_PNL", True)
LIVE_RECENT_LOSS_GUARD_ENABLED = _safe_env_bool("LIVE_RECENT_LOSS_GUARD_ENABLED", True)
...
LIVE_RECENT_LOSS_SIDE_BLOCK_WIN_RATE = _safe_env_float(
    "LIVE_RECENT_LOSS_SIDE_BLOCK_WIN_RATE", 0.40, lo=0.0, hi=1.0,
)
LIVE_RECENT_LOSS_SIDE_BLOCK_NET_PNL = _safe_env_float(
    "LIVE_RECENT_LOSS_SIDE_BLOCK_NET_PNL", -5.0, lo=-1_000_000.0, hi=1_000_000.0,
)
LIVE_RECENT_LOSS_COIN_SIDE_MIN_CLOSED = _safe_env_int(
    "LIVE_RECENT_LOSS_COIN_SIDE_MIN_CLOSED", 2, lo=1, hi=1_000,
)
LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_WIN_RATE = _safe_env_float(
    "LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_WIN_RATE", 0.50, lo=0.0, hi=1.0,
)
LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_NET_PNL = _safe_env_float(
    "LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_NET_PNL", -2.0, lo=-1_000_000.0, hi=1_000_000.0,
)
...
SHORT_HARDENING_BLOCK_NET_PNL = float(os.environ.get("SHORT_HARDENING_BLOCK_NET_PNL", -5.0))
...
def _validate_config_bounds() -> None:
    ...
    rules = [
        ...
        ("LIVE_RECENT_LOSS_LOOKBACK_FILLS", 1, 100_000, 200),
        ("LIVE_RECENT_LOSS_SIDE_MIN_CLOSED", 1, 1_000, 5),
        ("LIVE_RECENT_LOSS_SIDE_BLOCK_WIN_RATE", 0.0, 1.0, 0.40),
        ("LIVE_RECENT_LOSS_SIDE_BLOCK_NET_PNL", -1_000_000.0, 1_000_000.0, -5.0),
        ("LIVE_RECENT_LOSS_COIN_SIDE_MIN_CLOSED", 1, 1_000, 2),
        ("LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_WIN_RATE", 0.0, 1.0, 0.50),
        ("LIVE_RECENT_LOSS_COIN_SIDE_BLOCK_NET_PNL", -1_000_000.0, 1_000_000.0, -2.0),
        ...
        ("SHORT_HARDENING_BLOCK_NET_PNL", -1_000_000.0, 1_000_000.0, -5.0),
