        ...
        return LearningExample(
            ...
            metadata={
                ...
                "decision_metadata": {
                    ...
                    "proposed_size_usd": row.get("proposed_size_usd"),
                    "proposed_position_pct": row.get("proposed_position_pct"),
                    "proposed_leverage": row.get("proposed_leverage"),
                    "proposed_sl_roe": row.get("proposed_sl_roe"),
                    "proposed_tp_roe": row.get("proposed_tp_roe"),
                    "proposed_sl_price": row.get("proposed_sl_price"),
                    "proposed_tp_price": row.get("proposed_tp_price"),
                    "source_health": _loads(row.get("source_health"), {}) or {},
                    "regime": _loads(row.get("regime"), {}) or {},
                },
            },
